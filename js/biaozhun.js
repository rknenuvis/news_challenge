...
"标准(vi):可作为传统的人类居住地或使用地的杰出范例，<br>代表一种(或几种)文化，<br>尤其在不可逆转之变化的影响下变得易于损坏",
"标准(vii):与具特殊普遍意义的事件或现行传统或思想或<br>信仰或文学艺术作品有直接或实质的联系",
"标准(ix):构成代表地球演化史中重要阶段的突出例证",
"标准(x):构成代表进行中的重要地质过程、<br>生物演化过程以及人类与自然环境相互关系的突出例证",
    ...
    series: [
        ...
        },
        {
            ...
            data:[
                ...
                {value:9, name:'标准(vi):9项'},//可作为传统的人类居住地或使用\n地的杰出范例，代表一种(或几种)\n文化，尤其在不可逆转之变化的\n影响下变得易于损坏'},
                {value:21, name:'标准(vii):21项'},//与具特殊普遍意义的事件或\n现行传统或思想或信仰或\n文学艺术作品有直接或实质的联系。'},
                {value:12, name:'标准(ix):12项'},//构成代表地球演化史中重要阶段的突出例证'},
                {value:4, name:'标准(x):4项\n'},//构成代表进行中的重要地质过程、\n生物演化过程以及人类与自然环境\n相互关系的突出例证'},
